  ...
  return (
    <div className="min-h-screen bg-white text-gray-800 p-8">
      <div className="max-w-4xl mx-auto">
        ...
        >
          <h2 className="text-2xl font-semibold mb-4 text-gray-800">The GuruAvatar Approach to Skill Development</h2>
        ...
        >
          <h2 className="text-2xl font-semibold mb-4 text-gray-800">Key Areas of Skill Development</h2>
        ...
        >
          <h2 className="text-2xl font-semibold mb-4 text-gray-800">The Power of Expert-Guided Skill Development</h2>
          <div className="bg-gray-50 rounded-xl p-6 shadow-md">
        ...
        >
          <h2 className="text-2xl font-semibold mb-4 text-gray-800">Our Skill Development Process</h2>
        ...
        >
          ...
          <Link
            ...
            className="bg-purple-500 text-white px-8 py-4 rounded-full text-xl font-semibold hover:bg-purple-600 transition duration-300 inline-block"
          >
