// File: app/expert-mentorship/how-it-works/page.tsx
      ...
      <div className="max-w-6xl mx-auto">
        ...
        <div className="space-y-12">
          {steps.map((step, index) => (
            <motion.div
              key={index}
              className="flex flex-col md:flex-row items-center bg-white bg-opacity-10 p-6 rounded-xl"
              initial={{ opacity: 0, y: 20 }}
              animate={{ opacity: 1, y: 0 }}
        ...
        >
          <h2 className="text-3xl font-semibold mb-6 text-center">The GuruAvatar Mentorship Difference</h2>
          <ul className="space-y-4">
            <li className="flex items-start">
              <Users className="w-6 h-6 text-yellow-400 mr-4 flex-shrink-0 mt-1" />
              <span>Personalized matching using advanced AI algorithms</span>
            </li>
            <li className="flex items-start">
              <MessageSquare className="w-6 h-6 text-yellow-400 mr-4 flex-shrink-0 mt-1" />
              <span>Integrated communication tools for seamless mentor-mentee interaction</span>
            </li>
            <li className="flex items-start">
              <Target className="w-6 h-6 text-yellow-400 mr-4 flex-shrink-0 mt-1" />
              <span>AI-enhanced goal setting and progress tracking</span>
            </li>
            <li className="flex items-start">
              <ChartBar className="w-6 h-6 text-yellow-400 mr-4 flex-shrink-0 mt-1" />
              <span>Data-driven insights to optimize your learning journey</span>
            </li>
          </ul>
        </motion.section>
