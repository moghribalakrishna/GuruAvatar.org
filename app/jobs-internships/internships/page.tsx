    ...
    <div className="min-h-screen bg-gradient-to-b from-blue-900 to-teal-700 text-white p-4 sm:p-8">
      <div className="max-w-4xl mx-auto">
        ...
        >
          ...
          <p className="mb-6">Gain invaluable industry experience, build your professional network, and apply your academic knowledge in real-world settings. GuruAvatar connects you with internship opportunities that align with your career goals.</p>
        ...
        >
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            ...
            <textarea
              name="availability"
              placeholder="Availability (e.g., Summer 2024, Fall 2024)"
