      ...
      <div className="max-w-4xl mx-auto">
        ...
        >
          ...
          <div className="space-x-4">
            <Link href="/digital-detox-course" className="bg-blue-500 text-white px-6 py-3 rounded-full text-lg font-semibold hover:bg-blue-600 transition duration-300">
              Join Digital Detox Course
            </Link>
            <Link href="/mindful-tech-guide" className="bg-green-500 text-white px-6 py-3 rounded-full text-lg font-semibold hover:bg-green-600 transition duration-300">
              Download Mindful Tech Guide
            </Link>
          </div>
        </motion.section>
      </div>
