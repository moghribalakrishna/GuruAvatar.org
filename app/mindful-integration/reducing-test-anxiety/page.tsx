  ...
  return (
    <div className="min-h-screen bg-white text-gray-800 p-8">
      <div className="max-w-4xl mx-auto">
        ...
        >
          <h2 className="text-2xl font-semibold mb-4 text-gray-700">Understanding Test Anxiety</h2>
        ...
        >
          <h2 className="text-2xl font-semibold mb-4 text-gray-700">Common Symptoms of Test Anxiety</h2>
        ...
        >
          <h2 className="text-2xl font-semibold mb-4 text-gray-700">Strategies for Managing Test Anxiety</h2>
        ...
        >
          <h2 className="text-2xl font-semibold mb-4 text-gray-700">Mindful Breathing Exercise</h2>
          <p className="text-lg mb-4 text-gray-600">
          ...
          {!showExercise ? (
            ...
            <div className="text-center">
              ...
              <p className="text-lg mb-4 text-gray-600">Focus on your breath. Notice the sensation of breathing in and out.</p>
              <p className="text-lg text-gray-600">This exercise will end in 60 seconds.</p>
            </div>
          )}
        </motion.section>
        ...
        >
          <h2 className="text-2xl font-semibold mb-4 text-gray-700">Mindfulness Techniques for Exam Situations</h2>
          <ul className="list-disc list-inside space-y-2 text-gray-600">
        ...
        >
          <h2 className="text-2xl font-semibold mb-4 text-gray-700">Preparing for Exams Mindfully</h2>
          <ul className="list-disc list-inside space-y-2 text-gray-600">
        ...
        <motion.section 
          ...
          transition={{ duration: 0.5, delay: 0.8 }}
        >
          <h2 className="text-2xl font-semibold mb-4 text-gray-700">During the Exam: Mindful Strategies</h2>
        ...
        >
          <h2 className="text-2xl font-semibold mb-4 text-gray-700">After the Exam: Mindful Reflection</h2>
          <ul className="list-disc list-inside space-y-2 text-gray-600">
        ...
        >
          <h2 className="text-2xl font-semibold mb-4 text-gray-700">Long-term Strategies for Managing Test Anxiety</h2>
          <ul className="list-disc list-inside space-y-2 text-gray-600">
            <li>Develop a consistent daily meditation practice.</li>
        ...
        >
          <h2 className="text-2xl font-semibold mb-4 text-gray-700">Master Your Test Anxiety</h2>
