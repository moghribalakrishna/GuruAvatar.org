  ...
  return (
    <div className="min-h-screen bg-white text-gray-800 p-8">
      <div className="max-w-4xl mx-auto">
        ...
        >
          <h2 className="text-2xl font-semibold mb-4 text-gray-700">What is Mindful Eating?</h2>
        ...
        >
          <h2 className="text-2xl font-semibold mb-4 text-gray-700">Benefits of Mindful Eating</h2>
        ...
        >
          <h2 className="text-2xl font-semibold mb-4 text-gray-700">How to Practice Mindful Eating</h2>
        ...
        >
          <h2 className="text-2xl font-semibold mb-4 text-gray-700">Guided Mindful Eating Exercise</h2>
          <p className="text-lg mb-4 text-gray-600">
          ...
          {!showTimer ? (
            ...
            <div className="text-center">
              ...
              <p className="text-lg text-gray-600">Observe the food with all your senses. Notice its appearance, smell, texture, and taste. Eat slowly and mindfully.</p>
            </div>
          )}
        </motion.section>
        ...
        >
          <h2 className="text-2xl font-semibold mb-4 text-gray-700">Tips for Incorporating Mindful Eating into Daily Life</h2>
          <ul className="list-disc list-inside space-y-2 text-gray-600">
        ...
        <motion.section 
          ...
          transition={{ duration: 0.5, delay: 0.8 }}
        >
          <h2 className="text-2xl font-semibold mb-4 text-gray-700">Deepen Your Mindful Eating Practice</h2>
