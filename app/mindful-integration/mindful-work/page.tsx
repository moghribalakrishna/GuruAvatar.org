       ...
       <h2 className="text-2xl font-semibold mb-4">Overcoming Common Work and Study Challenges</h2>
        ...
        >
          ...
          <div className="space-x-4">
            <Link href="/productivity-course" className="bg-blue-500 text-white px-6 py-3 rounded-full text-lg font-semibold hover:bg-blue-600 transition duration-300">
              Join Mindful Productivity Course
            </Link>
            <Link href="/study-techniques" className="bg-green-500 text-white px-6 py-3 rounded-full text-lg font-semibold hover:bg-green-600 transition duration-300">
              Explore Mindful Study Techniques
            </Link>
          </div>
        </motion.section>
      </div>
