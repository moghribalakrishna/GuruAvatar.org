  ...
  return (
    <div className="bg-gradient-to-b from-blue-900 to-teal-700 min-h-screen text-white">
      <div className="container mx-auto px-4 py-16">
        ...
        {/* Founder's Vision and Mission Image */}
        <div className="text-center mb-12">
          <Image 
            src="/images/about/founder-vision-mission.webp" // Replace with the correct image path
            alt="Founder's Vision and Mission"
            width={800}
            height={400}
        ...
        {/* GuruAvatar Journey Timeline Image */}
        <div className="text-center mb-12">
          <Image 
            src="/images/about/guruavatar-journey.webp" // Replace with the correct image path
            alt="GuruAvatar Journey"
            width={800}
            height={400}
            className="rounded-lg mx-auto"
          />
        ...
        <section className="mb-16">
          ...
          {/* Growth and Impact Image */}
          <div className="text-center mb-12">
            <Image 
              src="/images/about/growth-impact.webp" // Replace with the correct image path
          ...
          {/* Technology and Traditional Education Integration Image */}
          <div className="text-center mb-12">
            <Image 
              src="/images/about/technology-traditional-education.webp" // Replace with the correct image path
              alt="Technology and Traditional Education Integration"
              width={800}
              height={400}
              className="rounded-lg mx-auto"
            />
